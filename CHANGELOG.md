...
## [4.18.1] - 2026-07-23
- Add icons
- Fix border color on Table component (native)
- Fix Input ay11 (Web)
- Fix progress classes mangled (Web)
- Fix progress radial props: small title & desc (Web)
- Fix columns and img of promptFile component (Web)
- Fix label of textarea (Web)
- Fix ghost button background (Native)
- Fix formatPattern on Input (Web)
- Add brand color
