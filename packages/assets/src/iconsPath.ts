...
export const SVGicons = {
  alert: require('@trilogy-ds/assets/lib/icons/all/alert.svg'),
  'arrow-down': require('@trilogy-ds/assets/lib/icons/all/arrow-down.svg'),
  ...
  check: require('@trilogy-ds/assets/lib/icons/all/check.svg'),
