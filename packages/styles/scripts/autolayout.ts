...
export const DEFAULT_SPACING_MATRIX: DefaultSpacingMatrix = [
  ...
  [INSERT_SPACE_BETWEEN, 'p.text:not(:last-child)', 'default', THREE, TWO],
  ...
  [INSERT_SPACE_BETWEEN, '.title.is-level-1:not(:last-child)', 'default', SEVEN, SIX],
  [INSERT_SPACE_BETWEEN, '.title.is-level-2:not(:last-child)', 'default', SIX, FIVE],
  [INSERT_SPACE_BETWEEN, '.title.is-level-3:not(:last-child)', 'default', FOUR, THREE],
  [INSERT_SPACE_BETWEEN, '.title.is-level-4:not(:last-child)', 'default', THREE, TWO],
  [INSERT_SPACE_BETWEEN, '.title.is-level-5:not(:last-child)', 'default', THREE, TWO],
  [INSERT_SPACE_BETWEEN, '.title.is-level-6:not(:last-child)', 'default', THREE, TWO],
