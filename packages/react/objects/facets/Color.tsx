...
export const colors: Record<TrilogyColor, string[]> = {
  ...
  [TrilogyColor.NEUTRAL_LIGHT]: navigator.userAgent !== undefined ? ["grey-light", "#E9E9E9", "white", "#E9E9E9"] : ["#E9E9E9", "#E9E9E9"],
...
export const getColorStyle = (
  ...
  if (navigator.userAgent === undefined) {
    ...
    const colorArray = colors[trilogyColor] || colors.default
    const colorIndex =
