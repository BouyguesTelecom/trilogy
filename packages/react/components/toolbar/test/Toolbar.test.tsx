...
import { ToolbarSpace, ToolbarItem, ToolbarGroup, Toolbar } from '../index'
...
describe('Toolbar', () => {
  ...
  it('renders with custom background', () => {
    ...
    expect(container.firstChild).toHaveClass('toolbar', 'has-background-primary')
  })

  it('renders with custom background and className', () => {
    const { container } = render(<Toolbar background={TrilogyColor.SECONDARY} className='my-toolbar' />)
    expect(container.firstChild).toHaveClass('toolbar', 'has-background-secondary', 'my-toolbar')
  })
})

describe('ToolbarGroup', () => {
  it('renders with default props', () => {
    const { getByTestId } = render(<ToolbarGroup data-testid='toolbar-group'>toto</ToolbarGroup>)
...
describe('ToolbarItem component', () => {
  ...
  it('applies additional class names', () => {
    const { container } = render(<ToolbarItem className='test'>toto</ToolbarItem>)
  ...
  it('applies clipped-to-bottom class when clippedToBottom prop is true', () => {
    const { container } = render(<ToolbarItem clippedToBottom>toto</ToolbarItem>)
    expect(container.firstChild).toHaveClass('toolbar-item is-clipped-to-bottom')
  })

  it('does not apply clipped-to-bottom class when clippedToBottom prop is false', () => {
    const { container } = render(<ToolbarItem clippedToBottom={false}>toto</ToolbarItem>)
...
describe('ToolbarSpace', () => {
  it('should render with default props', () => {
    const { getByTestId } = render(<ToolbarSpace data-testid='toolbar-space' />)
  ...
  it('should render with additional classes', () => {
    const { getByTestId } = render(<ToolbarSpace className='my-toolbar-space' data-testid='toolbar-space' />)
    const toolbarSpace = getByTestId('toolbar-space')
