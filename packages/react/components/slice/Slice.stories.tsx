  ...
  <Slice {...args}>
    ...
    <SliceContent>
      <Text level={TextLevels.ONE}>
        Slice avec CTA simple (ici, un simple chevron)
      </Text>
...
export const SlicesMultiples: Story<SliceProps> = (args) => (
  <SliceList selectable>
    <Slice {...args}>
      ...
      <SliceBody>
        <SliceContent>
          ...
          <Text>
            Un texte supplémentaire pour décrire le contenu de laction
          </Text>
        </SliceContent>
        <SliceCta>
          <Button variant={"PRIMARY"} onClick={() => alert("click on cta")}>
    ...
    <Slice selectable>
      ...
      <SliceBody>
        <SliceImage
          src="https://design.bouyguestelecom.fr/phone.1da9ed96.png"
          alt="phone"
        />
        <SliceContent>
          <Text level={TextLevels.ONE}>
    ...
    <Slice>
      <SliceBody>
        <SliceImage
          rounded
          src="https://design.bouyguestelecom.fr/profil.14ef6e58.jpg"
          alt="phone"
        />
        <SliceContent>
