...
describe('Icon', () => {
  it('should renders an Icon component with a name', () => {
    const { getByTestId } = render(<Icon name={IconName.SEARCH} testId='search-icon' />)
  ...
  it('should calls the onClick function when clicked', () => {
    ...
    const { getByTestId } = render(<Icon name={IconName.SEARCH} onClick={handleClick} testId='search-icon' />)
    const icon = getByTestId('search-icon')
  ...
  it('should renders a status Icon component', () => {
    const { getByTestId } = render(<Icon name={IconName.SEARCH} status={IconStatus.ERROR} testId='search-icon' />)
    const icon = getByTestId('search-icon')
