...
describe('Modal component', () => {
  test('should View keep className with content', () => {
    render(<View data-testid={'DEFAULT'} className={'testClassName'}>With Content</View>)
  ...
  test('should View accept ul/button markup', () => {
    render(<><View markup={'ul'} data-testid={'DEFAULTUL'} className={'testClassName'}><li>Liste</li></View>
