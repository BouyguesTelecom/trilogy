...
export const Base: Story<AlertProps> = (args) => <Alert
  {...args} />
...
export const Variant: Story<AlertProps> = () => <> <Alert
  display
  alert={AlertState.INFO}
  title='Alert information'
  description='Lorem Ipsum is simply dummy text type and scrambled it to make a type specimen book..' /> <Alert
  display
