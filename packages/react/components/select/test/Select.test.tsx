...
describe("SELECT NATIVE WEB", () => {
  ...
  //   );
  //   const select = getByTestId("testId");
  //   expect(select.parentElement?.firstChild?.firstChild).toHaveClass(
  //     "tri-advisor"
  //   );
  // });
});
...
describe("SELECT  WEB", () => {
  ...
  //   expect(select.firstElementChild?.nextElementSibling).toHaveTextContent(
  //     "Label"
  //   );
  //   expect(
  //     select.firstElementChild?.nextElementSibling?.nextElementSibling
  ...
  //   );
  //   const select = getByTestId("testId");
  //   expect(select.nextElementSibling).toHaveAttribute(
  //     "data-is-open-options",
  //     "false"
  //   );
