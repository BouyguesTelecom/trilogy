...
import { StatusState, TrilogyColor, getColorStyle, getStatusStyle } from '@/objects'
...
describe('Switch component', () => {
  ...
  colors.forEach((color) => {
    test(`true trackColor should have ${getStatusStyle(color).color} color`, async () => {
      ...
      expect(getByTestId('switch-id').props.onTintColor).toBe(getStatusStyle(color).color)
    })
  })
})
