...
export const Base: Story<LinkProps> = (args) => (
  <>
    ...
    <Divider />
    <Text>
      Je suis dans un paragraphe et ceci est un <Link inline>lien standard</Link> tandis que ceci est un
...
export const Inverted: Story<LinkProps> = (args) => <div style={{ backgroundColor: '#25465f', padding: 10 }}><Link {...args}> Mot de passe oublié ?</Link></div>
Inverted.args = {
  inverted: true,
}
