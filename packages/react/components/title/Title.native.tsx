...
import { getTypographyBoldStyle, setTypographyAlign, setTypographyColor, TypographyBold } from '@/objects/index.native'
...
const Title = React.forwardRef<TitleNativeRef, TitleProps>(
  (
    ...
    if (skeleton) {
      titleView = (
        <Skeleton style={styles.skeleton} height={titlesLevels()} borderRadius={5}>
          {titleView}
        </Skeleton>
      )
    }
