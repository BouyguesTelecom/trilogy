...
import { Title, TitleLevels, TitleMarkup } from '@/components'
...
describe('Title component', () => {
  ...
  test('should have htmlContent', () => {
    render(<Title htmlContent={'<b>htmlContent</b>'} testId='htmlContentComponent' />)

    expect(screen.getByTestId('htmlContentComponent')).toContainHTML('<b>htmlContent</b>')
  })
