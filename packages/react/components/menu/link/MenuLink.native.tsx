 ...
 */
const MenuLink = ({ children, arrow, onClick, to, ...others }: MenuLinkProps): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      {arrow && (
        <Icon style={styles.menuIcon} color={IconColor.GREY} size={IconSize.SMALL} name={IconName.ARROW_RIGHT} />
      )}
    </TouchableOpacity>
  )
}
