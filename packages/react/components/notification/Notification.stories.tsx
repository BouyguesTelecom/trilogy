...
export const Simple: Story<NotificationProps> = (args) => <Notification {...args} />
Simple.args = {
  title: 'Notification',
  hasIcon: false,
}

export const Informative: Story<NotificationProps> = (args) => <Notification {...args} />
Informative.args = {
  title: 'Notification',
  info: true,
}
export const AvecUneDescription: Story<NotificationProps> = (args) => <Notification {...args} />
...
export const AvecUnCTA: Story<NotificationProps> = (args) => <Notification {...args} />
AvecUnCTA.args = {
...
export const VersionBannière: Story<NotificationProps> = (args) => <Notification {...args} />
