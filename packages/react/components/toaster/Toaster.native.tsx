...
import { AlertState, getAlertStyle, getBackgroundOfVariant, TrilogyColor } from '../../objects'
...
const Toaster: React.FC<{ props: ToasterProps }> = ({ props }) => {
  ...
  const color = getAlertStyle(alert) || getBackgroundOfVariant(TrilogyColor.SECONDARY)
