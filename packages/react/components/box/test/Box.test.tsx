...
describe('Box component', () => {
  ...
  test('Should have classes', () => {
    const { getByTestId } = render(
      <Box testId='box' shadowless background='SUCCESS' backgroundSrc='test' leftBorder='SUCCESS' flat hat />,
    )
    const box = getByTestId('box')
  ...
  test('Should have classes content', () => {
    const { getByTestId } = render(<BoxContent testId='boxContent' background='SUCCESS' />)
