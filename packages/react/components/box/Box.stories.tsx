...
export const Skeleton: Story<BoxProps> = (args) => (
  <Box {...args}>
    ...
    <BoxContent>
      <Text>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus nec iaculis mauris. Phasellus nec iaculis mauris.</Text>
    </BoxContent>
  </Box>
)
Skeleton.args = {
...
export const BoxAvecBackgroundImage: Story<BoxProps> = (args) => (
  <Box {...args}>
    <BoxContent>
      <Title level={TitleLevels.ONE} inverted>Box Title</Title>
      <Text inverted>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus nec iaculis mauris.</Text>
    </BoxContent>
  </Box>
)
  ...
  <Columns>
    <ColumnsItem>
      <Box {...args}>
        <BoxContent>
          <Title level={TitleLevels.ONE} inverted>Box Title</Title>
          <Text inverted>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
            labore et dolore magna aliqua. Sagittis aliquam malesuada bibendum arcu vitae elementum curabitur vitae.
            Quis eleifend quam adipiscing vitae proin sagittis nisl rhoncus.</Text>
        </BoxContent>
      </Box>
    </ColumnsItem>
    <ColumnsItem>
