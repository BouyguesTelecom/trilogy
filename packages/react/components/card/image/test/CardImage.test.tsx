...
describe("CardImage", () => {
  it("renders an image with the specified lib and alt attributes", () => {
    const { getByAltText } = render(
      <CardImage src="image.jpg" alt="Test Image" />
    );
  ...
  it("applies the specified size class when provided", () => {
    const { container } = render(
      <CardImage src="image.jpg" alt="Test Image" size={CardImageSize.SIZE_1} />
    );
  ...
  it("applies additional CSS classes when provided", () => {
    const { container } = render(
      <CardImage src="image.jpg" alt="Test Image" className="my-class" />
    );
  ...
  it("calls the onClick function when clicked", () => {
    ...
    const { container } = render(
      <CardImage src="image.jpg" alt="Test Image" onClick={handleClick} />
    );
