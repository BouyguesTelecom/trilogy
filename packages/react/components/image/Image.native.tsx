...
import { StyleSheet, Image as ImageNative, View, TouchableOpacity } from 'react-native'
 ...
 */
const Image = ({ src, alt, rounded, width, height, onClick, flex, ...others }: ImageProps): JSX.Element => {
