...
describe('Input', () => {
  ...
  it('should have aria label', () => {
    const { getByTestId } = render(<Input accessibilityLabel='input' testId='input' hasIcon />)
    const input = getByTestId('input')
  ...
  it('should render right type input', () => {
    getEnumNames(InputType).forEach((type) => {
      const { getByTestId } = render(<Input accessibilityLabel='input' testId={`input${type}`} hasIcon type={type} />)
  ...
  it('should have default value', () => {
    const { getByTestId } = render(<Input accessibilityLabel='input' testId='input' hasIcon defaultValue='dflt' />)
    const input = getByTestId('input')
    expect(input).toHaveValue('dflt')
  })

  it('should have correctly value', () => {
    const { getByTestId } = render(<Input accessibilityLabel='input' testId='input' hasIcon value='value' />)
    const input = getByTestId('input')
  ...
  it('should execute onSubmit event', () => {
    ...
    const { getByTestId } = render(
      <Input onSubmit={mockCallBack} accessibilityLabel='input' testId='input' hasIcon value='value' />,
    )
    const input = getByTestId('input')
  ...
  it('should execute onclick event', () => {
    const mockCallBack = jest.fn()
    const { getByTestId } = render(
      <Input onClick={mockCallBack} accessibilityLabel='input' testId='input' hasIcon value='value' />,
    )
    const input = getByTestId('input')
  ...
  it('should execute keyup event', () => {
    const mockCallBack = jest.fn()
    const { getByTestId } = render(
      <Input onKeyUp={mockCallBack} accessibilityLabel='input' testId='input' hasIcon value='value' />,
    )
    const input = getByTestId('input')
  ...
  it('should execute focus event', () => {
    const mockCallBack = jest.fn()
    const { getByTestId } = render(
      <Input onFocus={mockCallBack} focused accessibilityLabel='input' testId='input' hasIcon value='value' />,
    )
    const input = getByTestId('input')
  ...
  it('should execute blur event', () => {
    const mockCallBack = jest.fn()
    const { getByTestId } = render(
      <Input onBlur={mockCallBack} accessibilityLabel='input' testId='input' hasIcon value='value' />,
    )
    const input = getByTestId('input')
  ...
  it('should execute mousenter event', () => {
    const mockCallBack = jest.fn()
    const { getByTestId } = render(
      <Input onMouseEnter={mockCallBack} accessibilityLabel='input' testId='input' hasIcon value='value' />,
    )
    const input = getByTestId('input')
  ...
  it('should execute mouseleave event', () => {
    const mockCallBack = jest.fn()
    const { getByTestId } = render(
      <Input onMouseLeave={mockCallBack} accessibilityLabel='input' testId='input' hasIcon value='value' />,
    )
    const input = getByTestId('input')
  ...
  it('should be disabled', () => {
    const { getByTestId } = render(<Input accessibilityLabel='input' disabled testId='input' hasIcon value='value' />)
    const input = getByTestId('input')
  ...
  it('should have min max length', () => {
    const { getByTestId } = render(
      <Input minLength={12} maxLength={14} accessibilityLabel='input' disabled testId='input' hasIcon value='value' />,
    )
    const input = getByTestId('input')
  ...
  it('should have label', () => {
    const { getByTestId } = render(<Input placeholder='bonjour' testId='input' />)
    const input = getByTestId('input')
  ...
  it('should have status icon with click event', () => {
    ...
    status.forEach((status, i) => {
      const { getByTestId } = render(
        <Input onIconClick={mockCallBack} status={status.status} hasIcon testId={`input-${i}`} />,
      )
      const input = getByTestId(`input-${i}`)
      expect(input.nextElementSibling?.firstChild).toHaveClass('icon')
      expect(input.nextElementSibling?.firstChild?.firstChild).toHaveClass(status.icon)
  ...
  it('should have custom icon with click event', () => {
    const mockCallBack = jest.fn()
    const { getByTestId } = render(<Input onIconClick={mockCallBack} customIcon={IconName.BELL} testId='input' />)
    const input = getByTestId('input')
    fireEvent.click(input?.nextElementSibling as HTMLElement)
    expect(mockCallBack).toHaveBeenCalled()
  })
  ...
  it('should have custom icon left with click event', () => {
    const mockCallBack = jest.fn()
    const { getByTestId } = render(<Input onIconClick={mockCallBack} customIconLeft={IconName.BELL} testId='input' />)
    const input = getByTestId('input')
    expect(input.nextElementSibling?.firstChild).toHaveClass('icon')
  ...
  it('should have custom icon right with click event', () => {
    const mockCallBack = jest.fn()
    const { getByTestId } = render(<Input onIconClick={mockCallBack} customIconRight={IconName.BELL} testId='input' />)
    const input = getByTestId('input')
    expect(input.nextElementSibling?.firstChild).toHaveClass('icon')
    expect(input.nextElementSibling?.firstChild?.firstChild).toHaveClass('tri-bell')
    fireEvent.click(input?.nextElementSibling as HTMLElement)
  ...
  it('should have icon pwd right with click event', () => {
    const mockCallBack = jest.fn()
    const { getByTestId } = render(<Input onIconClick={mockCallBack} type='password' testId='input' />)
    const input = getByTestId('input')
  ...
  it('should have icon search right with click event', () => {
    const mockCallBack = jest.fn()
    const { getByTestId } = render(<Input onIconClick={mockCallBack} type={InputType.SEARCH} testId='input' />)
    const input = getByTestId('input')
    expect(input.nextElementSibling?.firstChild).toHaveClass('icon')
    expect(input.nextElementSibling?.firstChild?.firstChild).toHaveClass('tri-search')
    fireEvent.click(input?.nextElementSibling as HTMLElement)
    expect(mockCallBack).toHaveBeenCalled()
  })
