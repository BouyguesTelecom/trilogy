...
import { Icon, IconColor, IconName, IconNameValues, IconSize } from '@/components/icon'
 ...
 * @param value {string} Controlled value for Input
 * @param focused {boolean} Focus mode
 * @param className {string} Additional CSS Classes
 * @param id {string} Custom id attribute (auto-generated by default)
