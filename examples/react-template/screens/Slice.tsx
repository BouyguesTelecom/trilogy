    ...
    <Section>
      <Slice>
        ...
        <SliceContent>
          <Text level={TextLevels.ONE}>
            Slice with simple CTA (here, a simple chevron)
          </Text>
      ...
      <SliceList selectable>
        ...
        <Slice selectable>
          ...
          <SliceBody>
            <SliceImage
              src="https://images.pexels.com/photos/18254878/pexels-photo-18254878/free-photo-of-eau-desert-rochers-source-chaude.jpeg"
              alt="phone"
            />
            <SliceContent>
              <Text level={TextLevels.ONE}>
