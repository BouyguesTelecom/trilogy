  ...
  return (
    <Section>
      <AutoLayout>
        ...
        <Divider />
        <Box>
          <BoxHeader variant={TrilogyColor.SECONDARY}>
        ...
        <Columns>
          ...
          <ColumnsItem>
                <Box backgroundSrc={'https://picsum.photos/id/1/1500/600'}>
                  <Title level={TitleLevels.THREE} typo={[TypographyAlign.TEXT_CENTERED, TypographyColor.TEXT_WHITE]}>Box with background image</Title>
