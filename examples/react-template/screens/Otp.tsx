...
import { Section, Title, TitleLevels, Otp, Spacer, SpacerSize } from '@trilogy-ds/react/components'
  ...
  return (
    <Section>
      ...
      <Otp
        ...
        onCompleted={(code) => console.log('onCompleted', code)} label='Set your OTP'
        autoFocus
      />
